...
class CarcadeLeasingApplicationCreate(BaseModel):
    # Личные данные
...
class CarcadeLeasingApplicationUpdate(BaseModel):
...
class CarcadeLeasingApplicationResponse(BaseModel):
    id: str = Field(..., description="ID заявки")
    application_type: str = Field(default="carcade_leasing", description="Тип заявки")
...
class CarcadeLeasingStats(BaseModel):
...
class CarcadeLeasingListResponse(BaseModel):
    total: int = Field(..., description="Общее количество заявок")
    page: int = Field(..., description="Текущая страница")
    page_size: int = Field(..., description="Размер страницы")
    data: List[CarcadeLeasingApplicationResponse] = Field(..., description="Список заявок")
