...
const RSHBCreditPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await applicationsApi.submitRSHBCreditApplication(applicationData);
      console.log('RSHB Credit application submitted:', response.data);
      setSubmitSuccess(true);
      reset();
      setTimeout(() => setSubmitSuccess(false), 5000);
    } catch (error) {
      console.error('Error submitting RSHB credit application:', error);
