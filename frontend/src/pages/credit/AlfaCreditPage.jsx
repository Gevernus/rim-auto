...
const AlfaCreditPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await applicationsApi.submitAlfaCreditApplication(applicationData);
      console.log('Alfa Credit application submitted:', response.data);
      setSubmitSuccess(true);
      reset();
      setTimeout(() => setSubmitSuccess(false), 5000);
    } catch (error) {
      console.error('Error submitting Alfa credit application:', error);
