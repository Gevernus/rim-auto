...
const UralCreditPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await applicationsApi.submitUralCreditApplication(applicationData);
      console.log('Ural Credit application submitted:', response.data);
      setSubmitSuccess(true);
      reset();
      setTimeout(() => setSubmitSuccess(false), 5000);
    } catch (error) {
      console.error('Error submitting Ural credit application:', error);
