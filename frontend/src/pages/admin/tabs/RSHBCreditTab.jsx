...
const RSHBCreditTab = () => {
	...
	const loadApplications = async () => {
		...
		try {
			...
			const response = await applicationsApi.getRSHBCreditApplications(params);
	...
	const onUpdateStatus = async (applicationId, newStatus) => {
		try {
			await applicationsApi.updateRSHBCreditStatus(applicationId, newStatus);
	...
	const onDelete = async (applicationId) => {
		...
		try {
			await applicationsApi.deleteRSHBCreditApplication(applicationId);
			await loadApplications();
		} catch (error) {
