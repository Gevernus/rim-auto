...
const RenesansCreditTab = () => {
	...
	const loadApplications = async () => {
		...
		try {
			...
			const response = await applicationsApi.getRenesansCreditApplications(params);
	...
	const onUpdateStatus = async (applicationId, newStatus) => {
		try {
			await applicationsApi.updateRenesansCreditStatus(applicationId, newStatus);
	...
	const onDelete = async (applicationId) => {
		...
		try {
			await applicationsApi.deleteRenesansCreditApplication(applicationId);
			await loadApplications();
		} catch (error) {
