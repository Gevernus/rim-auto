...
const AlfaCreditTab = () => {
	...
	const loadApplications = async () => {
		...
		try {
			...
			const response = await applicationsApi.getAlfaCreditApplications(params);
	...
	const onUpdateStatus = async (applicationId, newStatus) => {
		try {
			await applicationsApi.updateAlfaCreditStatus(applicationId, newStatus);
	...
	const onDelete = async (applicationId) => {
		...
		try {
			await applicationsApi.deleteAlfaCreditApplication(applicationId);
			await loadApplications();
		} catch (error) {
