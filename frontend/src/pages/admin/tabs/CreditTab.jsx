...
const CreditTab = () => {
	...
	const loadApplications = async () => {
		...
		try {
			...
			const response = await applicationsApi.getCreditApplications(params);
	...
	const onUpdateStatus = async (applicationId, newStatus) => {
		try {
			await applicationsApi.updateApplicationStatus('credit', applicationId, newStatus);
	...
	return (
		<div>
			...
			{/* Панель данных по кредитным заявкам */}
