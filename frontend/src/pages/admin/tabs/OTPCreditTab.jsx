...
const OTPCreditTab = () => {
	...
	const loadApplications = async () => {
		...
		try {
			...
			const response = await applicationsApi.getOTPCreditApplications(params);
	...
	const onUpdateStatus = async (applicationId, newStatus) => {
		try {
			await applicationsApi.updateOTPCreditStatus(applicationId, newStatus);
	...
	const onDelete = async (applicationId) => {
		...
		try {
			await applicationsApi.deleteOTPCreditApplication(applicationId);
			await loadApplications();
		} catch (error) {
