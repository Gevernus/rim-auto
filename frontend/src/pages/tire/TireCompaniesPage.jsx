...
const companies = [
  { name: 'FIT SERVICE', slug: 'fit-service', logo: fitLogo, hours: '09:00 - 21:00' },
];
...
const TireCompaniesPage = () => {
  const { navigateTo } = useAppNavigation();
  const handleOpen = (slug) => navigateTo(routes.tireCompany(slug));
